      ...
      <div className="max-w-container-max mx-auto space-y-20">
        ...
        <div className="space-y-10" id="web-development-section">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 border-b border-gray-200 pb-6">
            ...
            >
              <span>View Dedicated Web Dev Page</span>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 border-b border-gray-200 pb-6">
            <div className="space-y-2">
              ...
              <p className="text-gray-600 max-w-xl text-sm leading-relaxed">
                Data-backed Meta &amp; Google ad strategies engineered for high ROAS, qualified leads, and measurable growth.
              </p>
            </div>
            <Link
              ...
              className="text-xs font-mono-code font-bold uppercase tracking-wider text-[#4b5a20] hover:underline flex items-center gap-1"
            >
              <span>View Dedicated Performance Marketing Page</span>
              <span className="material-symbols-outlined text-sm">
                arrow_forward
              </span>
            </Link>
        ...
        <div className="bg-gray-50 rounded-3xl p-10 md:p-14 border border-gray-200 text-center space-y-8 shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="space-y-2 p-4 bg-white rounded-2xl border border-gray-200 shadow-xs">
              <div className="text-4xl font-extrabold font-mono-code text-[#4b5a20]">
                $45M+
              </div>
