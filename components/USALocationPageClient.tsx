      ...
      <section className="relative w-full overflow-hidden bg-[#fafaee] pt-10 pb-20 lg:py-24 border-b border-[#E2E8D5]">
        ...
        <div className="relative max-w-[1320px] mx-auto px-6 lg:px-12">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex flex-col items-center gap-6 reveal-bottom">
              ...
              {/* Micro Proof Points */}
              <div className="pt-2 flex flex-wrap justify-center items-center gap-y-2 gap-x-6 text-[#606853] font-mono-code text-xs">
            ...
            {/* Right Hero Card & Topographic Graphic - commented out */}
            {/* <div className="lg:col-span-5 relative reveal-right">
              <div className="relative rounded-2xl bg-white border border-[#E2E8D5] shadow-[0_20px_50px_-12px_rgba(40,53,0,0.08)] p-6 sm:p-8 overflow-hidden">
                ...
                <div className="relative my-6 py-2 flex items-center justify-center">...</div>
                <div className="flex flex-wrap items-center justify-between gap-1.5 pb-5 pt-1 border-b border-[#E2E8D5] text-center">...</div>
                <div className="grid grid-cols-3 gap-3 pt-5">...</div>
              </div>
            </div> */}
