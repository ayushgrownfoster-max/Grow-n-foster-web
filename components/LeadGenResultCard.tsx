import { ClientResultCard } from "@/data/leadGenPortfolio";

interface LeadGenResultCardProps {
  card: ClientResultCard;
}

export default function LeadGenResultCard({ card }: LeadGenResultCardProps) {
  return (
